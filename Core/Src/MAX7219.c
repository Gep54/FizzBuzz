...
#define CS_SET() 	HAL_GPIO_WritePin(cs_display_GPIO_Port, cs_display_Pin, GPIO_PIN_RESET)
#define CS_RESET() 	HAL_GPIO_WritePin(cs_display_GPIO_Port, cs_display_Pin, GPIO_PIN_SET)
